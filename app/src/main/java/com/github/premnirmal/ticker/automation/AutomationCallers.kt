...
object AutomationCallers {
    ...
    // Five distinct refusals plus the pass, each naming a different mistake with a different fix —
    // which is the whole point of answering a string rather than a boolean, and is worth more than
    // detekt's four-return limit. This repo's detekt runs at maxIssues 0, so the suppression is
